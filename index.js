...
async function startServer() {
  ...
  ModelLoader.loadModels(process.env.NODE_ENV === 'production', false).then((success) => {
    if (success) {
      console.log('All server models loaded successfully')
    } else {
      console.warn('Some models failed to load')
    }
  })
